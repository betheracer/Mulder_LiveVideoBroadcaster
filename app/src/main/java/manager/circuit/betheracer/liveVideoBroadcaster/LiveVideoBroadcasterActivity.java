...
import manager.circuit.betheracer.broadcaster.ILiveVideoBroadcaster;
import manager.circuit.betheracer.broadcaster.LiveVideoBroadcaster;
import manager.circuit.betheracer.broadcaster.utils.Resolution;

import static manager.circuit.betheracer.MainActivity.RTMP_BASE_URL;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    public void showSetResolutionDialog(View v) {
        ...
        Fragment fragmentDialog = getFragmentManager().findFragmentByTag("dialog");
